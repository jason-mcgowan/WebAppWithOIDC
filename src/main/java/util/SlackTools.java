...
public class SlackTools {
  ...
  public static String loginButton(String redirectUri, String clientId) {
    return "<a href=\"https://slack.com/openid/connect/authorize?scope=openid%20email%20profile&amp;response_type=code&amp;"
